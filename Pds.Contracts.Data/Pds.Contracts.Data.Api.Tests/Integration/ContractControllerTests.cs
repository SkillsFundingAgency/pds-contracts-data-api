...
namespace Pds.Contracts.Data.Api.Tests.Integration
{
    ...
    public class ContractControllerTests
    {
        ...
        private List<DataModels.Contract> GetDataModelContracts()
        {
            ...
            {
                new DataModels.Contract { Id = 1, Title = title, ContractNumber = contractNumber + "1", ContractVersion = 1, Ukprn = 12345678, Year = "2021", CreatedAt = lastEmailReminderSent.AddDays(-45), LastEmailReminderSent = lastEmailReminderSent, Status = (int)ContractStatus.PublishedToProvider, FundingType = (int)ContractFundingType.AdvancedLearnerLoans, ContractContent = GetDataModelContractContent(1) },
                new DataModels.Contract { Id = 2, Title = title, ContractNumber = contractNumber + "2", ContractVersion = 2, Ukprn = 12345678, Year = "2021", CreatedAt = lastEmailReminderSent.AddDays(-45), LastEmailReminderSent = null, Status = (int)ContractStatus.PublishedToProvider, FundingType = (int)ContractFundingType.AdvancedLearnerLoans },
                new DataModels.Contract { Id = 3, Title = title, ContractNumber = contractNumber + "3", ContractVersion = 3, Ukprn = 12345678, Year = "2021", CreatedAt = lastEmailReminderSent.AddDays(-45), LastEmailReminderSent = null, Status = (int)ContractStatus.PublishedToProvider, FundingType = (int)ContractFundingType.AdvancedLearnerLoans },
                new DataModels.Contract { Id = 4, Title = title, ContractNumber = contractNumber + "4", ContractVersion = 1, Ukprn = 12345678, Year = "2021", CreatedAt = lastEmailReminderSent, LastEmailReminderSent = null, Status = (int)ContractStatus.ApprovedWaitingConfirmation, FundingType = (int)ContractFundingType.AdvancedLearnerLoans },
                new DataModels.Contract { Id = 5, Title = title, ContractNumber = contractNumber + "5", ContractVersion = 1, Ukprn = 123456785, Year = "2021", CreatedAt = lastEmailReminderSent, LastEmailReminderSent = null, Status = (int)ContractStatus.PublishedToProvider, FundingType = (int)ContractFundingType.AdvancedLearnerLoans, ContractContent = GetDataModelContractContent(5) },
                new DataModels.Contract { Id = 6, Title = title, ContractNumber = contractNumber + "6", ContractVersion = 1, Ukprn = 123456786, Year = "2021", CreatedAt = lastEmailReminderSent, LastEmailReminderSent = null, Status = (int)ContractStatus.ApprovedWaitingConfirmation, FundingType = (int)ContractFundingType.AdvancedLearnerLoans, ContractContent = GetDataModelContractContent(6) },
                new DataModels.Contract { Id = 7, Title = title, ContractNumber = contractNumber + "7", ContractVersion = 1, Ukprn = 12345678, Year = "2021", CreatedAt = lastEmailReminderSent, Status = (int)ContractStatus.PublishedToProvider },
                new DataModels.Contract { Id = 8, Title = title, ContractNumber = contractNumber + "8", ContractVersion = 1, Ukprn = 12345678, Year = "2021", CreatedAt = lastEmailReminderSent, Status = (int)ContractStatus.PublishedToProvider },
                new DataModels.Contract { Id = 9, Title = title, ContractNumber = "Test-Contract-High", ContractVersion = 10, Ukprn = 12345678, Year = "2021", CreatedAt = lastEmailReminderSent, LastEmailReminderSent = null, Status = (int)ContractStatus.ApprovedWaitingConfirmation, FundingType = (int)ContractFundingType.AdvancedLearnerLoans },
                new DataModels.Contract { Id = 10, Title = title, ContractNumber = "Test-Contract-High", ContractVersion = 1, Ukprn = 12345678, Year = "2021", CreatedAt = lastEmailReminderSent, Status = (int)ContractStatus.PublishedToProvider, ContractData = new DataModels.ContractData() { Id = 10, OriginalContractXml = "<contract>sample.xml.data</contract>" } },
                new DataModels.Contract { Id = 11, Title = title, ContractNumber = contractNumber, ContractVersion = 2, Ukprn = 12345678, Year = "2021", CreatedAt = lastEmailReminderSent.AddDays(-45), LastEmailReminderSent = lastEmailReminderSent, Status = (int)ContractStatus.PublishedToProvider, FundingType = (int)ContractFundingType.AdvancedLearnerLoans, ContractContent = GetDataModelContractContent(11) },
                new DataModels.Contract { Id = 12, Title = title, ContractNumber = "Levy-0002", ContractVersion = 1, Ukprn = 12345678, Year = "2021", CreatedAt = lastEmailReminderSent.AddDays(-45), LastEmailReminderSent = lastEmailReminderSent, Status = (int)ContractStatus.PublishedToProvider },
            };
        }
